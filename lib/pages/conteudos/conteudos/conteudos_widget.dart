                          ...
                          child: Column(
                            ...
                            children: [
                              FutureBuilder<List<CategoriasDeConteudoRow>>(
                                future:
                                    CategoriasDeConteudoTable().querySingleRow(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CategoriasDeConteudoRow>
                                      textCategoriasDeConteudoRowList =
                                      snapshot.data!;

                                  final textCategoriasDeConteudoRow =
                                      textCategoriasDeConteudoRowList.isNotEmpty
                                          ? textCategoriasDeConteudoRowList
                                              .first
                                          : null;
                                    ...
                                    child: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: FutureBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<ModulosDeConteudoRow>
                                                    textModulosDeConteudoRowList =
                                                    snapshot.data!;

                                                final textModulosDeConteudoRow =
                                                    textModulosDeConteudoRowList
                                                            .isNotEmpty
                                                        ? textModulosDeConteudoRowList
                                                            .first
                                          ...
                                          FutureBuilder<List<ConteudosRow>>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<ConteudosRow>
                                                  listViewConteudosRowList =
                                                  snapshot.data!;

                                              if (listViewConteudosRowList
                                                  .isEmpty) {
                                                return EmptyListWidget(
                                                  texto:
                                                      'Nenhum conteúdo encontrado para este módulo e categoria',
                                                );
                                              }
