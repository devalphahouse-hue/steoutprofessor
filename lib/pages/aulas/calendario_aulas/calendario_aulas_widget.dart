                                                      ...
                                                      children: [
                                                        ...
                                                        FutureBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            final columnListaAulasDoDiaResponse =
                                                                snapshot.data!;

                                                            return Builder(
                                                              builder:
                                                                  (context) {
                                                                final aulasDoDia = (columnListaAulasDoDiaResponse
                                                                            .jsonBody
                                                                            .toList()
                                                                            .map<ItemCalendarioAulasStruct?>(ItemCalendarioAulasStruct.maybeFromMap)
                                                                            .toList() as Iterable<ItemCalendarioAulasStruct?>)
                                                                        .withoutNulls
                                                                        ?.where((e) => e.idProfessor == currentUserUid)
                                                                        .toList()
                                                                        ?.toList() ??
                                                                    [];
                                                                                        ...
                                                                                        children: [
                                                                                          RichText(
                                                                                            ...
                                                                                            text: TextSpan(
                                                                                              children: [
                                                                                                ...
                                                                                                TextSpan(
                                                                                                  text: aulasDoDiaItem.nomeProfessor,
                                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                        font: GoogleFonts.inter(
                                                                                                          fontWeight: FlutterFlowTheme.of(context).bodyMedium.fontWeight,
                                                                                                          fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                          ...
                                                                                          RichText(
                                                                                            ...
                                                                                            text: TextSpan(
                                                                                              children: [
                                                                                                ...
                                                                                                TextSpan(
                                                                                                  text: aulasDoDiaItem.quantidadeAlunosConvidados.toString(),
                                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                        font: GoogleFonts.inter(
                                                                                                          fontWeight: FlutterFlowTheme.of(context).bodyMedium.fontWeight,
                                                                                                          fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                          ...
                                                                                          RichText(
                                                                                            ...
                                                                                            text: TextSpan(
                                                                                              children: [
                                                                                                TextSpan(
                                                                                                  text: aulasDoDiaItem.statusAula,
                                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                        font: GoogleFonts.inter(
                                                                                                          fontWeight: FlutterFlowTheme.of(context).bodyMedium.fontWeight,
                                                                                                          fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                            ...
                                                                                            text: TextSpan(
                                                                                              children: [
                                                                                                TextSpan(
                                                                                                  text: dateTimeFormat(
                                                                                                    "Hm",
                                                                                                    functions.stringToDatetime(aulasDoDiaItem.datetimeInicioAula),
                                                                                                ...
                                                                                                TextSpan(
                                                                                                  text: dateTimeFormat(
                                                                                                    "Hm",
                                                                                                    functions.stringToDatetime(aulasDoDiaItem.datetimeTerminoAula),
                                                                                                    locale: FFLocalizations.of(context).languageCode,
                                                                                                  ),
                                                                                                  style: TextStyle(),
                                                                                                )
