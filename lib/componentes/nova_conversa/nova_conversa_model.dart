...
class NovaConversaModel extends FlutterFlowModel<NovaConversaWidget> {
  ...
  final _listaUserManager = FutureRequestManager<ApiCallResponse>();
  Future<ApiCallResponse> listaUser({
    String? uniqueQueryKey,
    bool? overrideCache,
    required Future<ApiCallResponse> Function() requestFn,
  }) =>
      _listaUserManager.performRequest(
        uniqueQueryKey: uniqueQueryKey,
        overrideCache: overrideCache,
        requestFn: requestFn,
      );
  void clearListaUserCache() => _listaUserManager.clear();
  void clearListaUserCacheKey(String? uniqueKey) =>
      _listaUserManager.clearRequest(uniqueKey);
