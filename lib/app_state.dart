...
class FFAppState extends ChangeNotifier {
  ...
  int _jaasEndSignal = 0;
  int get jaasEndSignal => _jaasEndSignal;
  set jaasEndSignal(int value) {
    _jaasEndSignal = value;
  }

  List<String> _idsConteudo = [];
  List<String> get idsConteudo => _idsConteudo;
  set idsConteudo(List<String> value) {
    _idsConteudo = value;
  }

  void addToIdsConteudo(String value) {
    idsConteudo.add(value);
  }

  void removeFromIdsConteudo(String value) {
    idsConteudo.remove(value);
  }

  void removeAtIndexFromIdsConteudo(int index) {
    idsConteudo.removeAt(index);
  }

  void updateIdsConteudoAtIndex(
    int index,
    String Function(String) updateFn,
  ) {
    idsConteudo[index] = updateFn(_idsConteudo[index]);
  }

  void insertAtIndexInIdsConteudo(int index, String value) {
    idsConteudo.insert(index, value);
  }
}
